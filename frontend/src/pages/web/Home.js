...
import {Banner, VideoJS, BasicModal, FormularioModal, FormularioModalStreaming} from "../../components/Web";
...
export function Home() {
  ...
  const onOpenCloseModalLocal = () => setShowModalLocal((prevState) => !prevState);
  const onOpenCloseModalStream = () => setShowModalStream((prevState) => !prevState);
  ...
  return (
    ...
    <div>
        ...
        <Button primary onClick={onOpenCloseModalLocal}>Cargar video</Button>
        <p> </p>
        <Button primary onClick={onOpenCloseModalStream}>Cargar URL</Button>
        </div>
